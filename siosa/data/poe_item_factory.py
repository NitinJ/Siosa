...
INFLUENCES = [
    "Shaper", "Elder", "Crusader", "Warlord", "Hunter", "Redeemer"
]

# Creates poe items from poe clipboard data or from stash api.
class PoeItemFactory:
    ...
    def _get_influences(self, sections):
        ...
        for section in sections:
            ...
            for line in section:
                influence_section = sum([line.find(influence) > -1 for influence in INFLUENCES]) != 0
