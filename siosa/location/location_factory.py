...
class Locations:
    SCREEN_CENTER = Location(Resolutions.p1080.w / 2, Resolutions.p1080.h / 2,
                             ...
                             Resolutions.p1080, "SCREEN_CENTER")

    # Currency tab
    CURRENCY_CENTER = Location(295, 396, 371, 555, Resolutions.p1080,
                               "CURRENCY_CENTER")
    CURRENCY_ALTERATION = Location(98, 275, 131, 311,
                                   Resolutions.p1080, "CURRENCY_ALTERATION")
    CURRENCY_AUGMENT = Location(217, 329, 245, 359, Resolutions.p1080,
                                "CURRENCY_AUGMENT")

    # Decorations
    EDIT_HIDEOUT_ARROW = Location(1172, 1043, 1185, 1058,
                                  Resolutions.p1080, "EDIT_HIDEOUT_ARROW")
    EDIT_HIDEOUT_DOWN_ARROW = Location(1172, 924, 1187, 937,
                                       Resolutions.p1080,
                                       "EDIT_HIDEOUT_DOWN_ARROW")
    EDIT_HIDEOUT_BUTTON = Location(1008, 963, 1064, 1035,
                                   Resolutions.p1080, "EDIT_HIDEOUT_BUTTON")
    OPEN_DECORATIONS_BUTTON = Location(1095, 960, 1143, 999,
                                       Resolutions.p1080,
                                       "OPEN_DECORATIONS_BUTTON")
    STASH_DECORATION = Location(1416, 468, 1496, 542, Resolutions.p1080,
                                "STASH_DECORATION")
    CLOSE_DECORATIONS_BUTTON = Location(1879, 60, 1892, 74,
                                        Resolutions.p1080,
                                        "CLOSE_DECORATIONS_BUTTON")
    CLOSE_STASH_BUTTON = Location(620, 57, 636, 77, Resolutions.p1080,
                                  "CLOSE_STASH_BUTTON")

    # Stash
    FIRST_STASH_TAB_RIGHT_LIST = Location(690, 134, 860, 154,
                                          Resolutions.p1080,
                                          "FIRST_STASH_TAB_RIGHT_LIST")

    # Inventory
    INVENTORY = Location(1260, 579, 1915, 861, Resolutions.p1080, "INVENTORY")
    INVENTORY_0_0 = Location(1274, 590, 1324, 640, Resolutions.p1080,
                             "INVENTORY_0_0")
    INVENTORY_0_0_WITH_RIGHT_BORDER = Location(1274, 590, 1327, 640,
                                               Resolutions.p1080,
                                               "INVENTORY_0_0_WITH_RIGHT_BORDER")
    INVENTORY_0_0_WITH_BOTTOM_BORDER = Location(1274, 590, 1324, 643,
                                                Resolutions.p1080,
                                                "INVENTORY_0_0_WITH_BOTTOM_BORDER")
    INVENTORY_DIVIDER_HORIZONTAL = Location(1283, 638, 1315, 644,
                                            Resolutions.p1080,
                                            "INVENTORY_DIVIDER_HORIZONTAL")
    INVENTORY_DIVIDER_VERTICAL = Location(1321, 599, 1327, 631,
                                          Resolutions.p1080,
                                          "INVENTORY_DIVIDER_VERTICAL")
    ...
    # Banners
    STASH_BANNER = Location(288, 56, 375, 81, Resolutions.p1080, "STASH_BANNER")
