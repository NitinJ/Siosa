class TemplateRegistry:
    ...
    TRADE_WINDOW_ME_EMPTY_TEXT = ("sct-tmp-TRADE_WINDOW_ME_EMPTY_TEXT.png", (1920, 1080))
    TRADE_WINDOW_OTHER = ("sct-tmp-TRADE_WINDOW_OTHER.png", (1920, 1080))
    TRADE_WINDOW_OTHER_0_0 = ("sct-tmp-TRADE_WINDOW_OTHER_0_0.png", (1920, 1080))
    TRADE_ACCEPT_RETRACTED = ("sct-tmp-TRADE_ACCEPT_RETRACTED.png", (1920, 1080))
